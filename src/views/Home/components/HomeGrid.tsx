  ...
  return (
    <nav className="home-grid__wrapper" ref={nodeWrapperRef}>
      <div className="home-grid home-grid--shrinked">
        <div className="home-grid__box home-grid__box--no-bg home-grid__box--different home-grid-animate animate-from-left"><span>Jacopo Marrone</span><span>Web Developer</span></div>
